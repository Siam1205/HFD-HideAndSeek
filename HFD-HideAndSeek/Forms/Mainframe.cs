...
using HFD_HideAndSeek.Properties;
using HFD_HideAndSeek.Steganography.DataStructures;
using HFD_HideAndSeek.Steganography.Logic;
...
namespace HFD_HideAndSeek.Forms {
	...
	public sealed partial class Mainframe : Form {
		...
		private void mainframe_Load(object sender, EventArgs e) {
			...
			// Load button images
			this.loadCarrierButton.Image = (Image) (new Bitmap(Resources.load, new Size(22, 22)));
			this.loadMessageButton.Image = (Image) (new Bitmap(Resources.load, new Size(22, 22)));
			this.loadStegoImageButton.Image = (Image) (new Bitmap(Resources.load, new Size(22, 22)));

			this.clearCarrierAndMessageButton.Image = (Image) (new Bitmap(Resources.forbidden, new Size(22, 22)));
			this.clearStegoButton.Image = (Image) (new Bitmap(Resources.forbidden, new Size(22, 22)));

			this.showCarrierBitplanesButton.Image = (Image) (new Bitmap(Resources.binary_2, new Size(21, 21)));
			this.showStegoImageBitplanesButton.Image = (Image) (new Bitmap(Resources.binary_2, new Size(21, 21)));

			this.encryptMessageButton.Image = (Image) (new Bitmap(Resources.rightArrow, new Size(22, 22)));
			this.decryptMessageButton.Image = (Image) (new Bitmap(Resources.leftArrow, new Size(22, 22)));

			this.hideMessageButton.Image = (Image) (new Bitmap(Resources.rightArrow, new Size(22, 22)));
			this.extractMessageButton.Image = (Image) (new Bitmap(Resources.leftArrow, new Size(22, 22)));

			this.saveStegoImageButton.Image = (Image) (new Bitmap(Resources.save, new Size(19, 19)));
			this.saveMessageButton.Image = (Image) (new Bitmap(Resources.save, new Size(19, 19)));

			this.helpButton.Image = (Image) (new Bitmap(Resources.help_1, new Size(50, 50)));

			this.rateButton.Image = (Image) (new Bitmap(Resources.star, new Size(22, 22)));
		}
